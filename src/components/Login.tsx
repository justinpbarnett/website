  ...
  return (
    <div className="w-full max-w-md mx-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">choose a provider to continue</p>
      </div>
      ...
      <div className="space-y-4">
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 border-b border-transparent hover:border-gray-200 dark:hover:border-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
